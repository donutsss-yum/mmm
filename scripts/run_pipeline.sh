...
stage_file() {
  case "$1" in
    ...
    12)   echo "steps/12_exp_fit_consolidated.py" ;;
    13)   echo "steps/13_exp_scorecard_consolidated.py" ;;
    *)    echo "" ;;
  esac
}
...
stage_timeout() {
  case "$1" in
    ...
    12)   echo 21600 ;;    # experiment: 2 fits
    13)   echo 7200 ;;     # experiment scorecard
    *)    echo 3600 ;;
  esac
}
